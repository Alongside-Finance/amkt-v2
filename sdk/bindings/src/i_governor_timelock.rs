...
pub mod i_governor_timelock {
    ...
    pub static IGOVERNORTIMELOCK_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IGovernorTimelock<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IGovernorTimelock<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IGovernorTimelock))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IGovernorTimelock<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IGovernorTimelockEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for IGovernorTimelockCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IGovernorTimelockCalls {
