...
pub mod i_transparent_upgradeable_proxy {
    ...
    pub struct ChangeAdminCall(pub ::ethers::core::types::Address);
    ...
    impl ::ethers::core::abi::AbiDecode for ITransparentUpgradeableProxyCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ITransparentUpgradeableProxyCalls {
