contract Constants {
    ...
    uint256 constant _21CO_BNB_UNITS = 1511372; // same as 042024 units but 10 less decimals
    uint256 constant _21CO_SOL_UNITS = 44947438;
    uint256 constant _21CO_AVAX_UNITS = 38145831284909904;
}
